  ...
  return (
    <div>
      ...
      <div className="container mt-4" style={{ maxWidth: '900px' }}>
        <Link to="/content" className="btn btn-outline mb-3" data-testid="back-btn">
          ← Back to Collection
        </Link>
        ...
        <div className="card" style={{ padding: '3rem' }}>
          ...
          {content.audio_url && (
            <div className="mb-4" data-testid="audio-section">
              <h3 style={{ marginBottom: '1rem' }}>🎵 Listen</h3>
          ...
          {content.image_urls && content.image_urls.length > 0 && (
            <div className="mb-4" data-testid="images-section">
              <h3 style={{ marginBottom: '1rem' }}>🖼️ Sacred Imagery</h3>
          ...
          {content.video_urls && content.video_urls.length > 0 && (
            <div className="mb-4" data-testid="videos-section">
              <h3 style={{ marginBottom: '1rem' }}>🎬 Video Content</h3>
