    ...
    <div className="animate-fade-in max-w-4xl mx-auto px-4 py-8">
      ...
      {sant.biography && (
        <section className="mb-12">
          ...
          <div className="glass-card p-6 md:p-8 leading-relaxed text-sm text-white/70 whitespace-pre-line border border-white/10 shadow-2xl">
            {sant.biography.text}
          </div>
        </section>
      )}
            ...
            {sant.books.map(book => {
              ...
              return (
                <Link 
                  ...
                  className="glass-card p-5 group hover:border-amber-500/20 transition-all flex justify-between items-center"
                >
                  <div>
