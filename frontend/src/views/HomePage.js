    ...
    <div className="relative overflow-hidden animate-fade-in font-sans min-h-screen">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 py-2 animate-fade-in space-y-8 pt-3">
        ...
        <div className="py-8 max-w-4xl mx-auto border-t border-white/5 text-center text-xs text-white/35 leading-relaxed font-light space-y-4 select-none">
          ...
          <p>
            वृंदोपनिषद् पाठ: रस उपासना और वृन्दावाणि संतों की वाणी का एक पवित्र डिजिटल संग्रह। हमारा उद्देश्य संस्कृत ग्रंथों, स्तोत्रों, और कविताओं के अमूल्य ज्ञान को सुगम और सुंदर रूप में जिज्ञासुओं तक पहुँचाना है।
          </p>
