    ...
    <div className="animate-fade-in max-w-4xl mx-auto">
      ...
      <article className="py-12">
        ...
        <section className="prose-content">
          ...
          <p className="text-white/70 leading-relaxed mb-8">Vrindopnishad represents a creative synthesis of the classical Upanishadic tradition of deep philosophical inquiry with the Bhakti tradition of passionate devotional engagement. Rather than choosing between head and heart, it invites seekers to bring their whole being — intellect, emotion, will, and imagination — to the encounter with sacred truth. Explore the <Link to="/origin" className="text-primary hover:underline">historical origins</Link>, read the <Link to="/guide" className="text-primary hover:underline">complete guide</Link>, or dive into the <Link to="/lyrics" className="text-primary hover:underline">content library</Link> to experience this synthesis firsthand.</p>
        </section>
