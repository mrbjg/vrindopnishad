    ...
    <div className="animate-fade-in max-w-4xl mx-auto">
      ...
      <article className="py-12">
        ...
        <section className="prose-content">
          ...
          <p className="text-white/70 leading-relaxed mb-8">Understanding these concepts allows seekers to grasp the deep meanings behind the <Link to="/granthas" className="text-primary hover:underline">sacred granthas</Link> of Swami Haridas (Kelimal) and Hit Harivansh (Sphut Vaani). To dive deeper into these teachings, explore our <Link to="/philosophy" className="text-primary hover:underline">philosophy page</Link> or look up specific verses under the <Link to="/lyrics" className="text-primary hover:underline">complete list of Vaani texts</Link>.</p>
        </section>
