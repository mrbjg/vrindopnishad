  ...
  return (
    <div className={`flex flex-wrap items-center gap-3 mt-8 ${className}`}>
      ...
      <a
        ...
        className="w-8 h-8 rounded-full border border-white/10 flex items-center justify-center bg-white/[0.02] hover:bg-amber-500/10 hover:border-amber-500/30 text-white/70 hover:text-amber-400 transition-all duration-300"
        title="Share on X"
