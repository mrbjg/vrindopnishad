...
def main():
    ...
    print("Cleaning all existing records from Supabase content table...")
    try:
        # Delete all records by matching all IDs that are not a dummy value
        supabase_client.table('content').delete().neq('id', '00000000-0000-0000-0000-000000000000').execute()
        print("🎉 Cleaned Supabase content table successfully.")
    except Exception as e:
        print(f"⚠️ Warning: Failed to clean Supabase content table: {e}. Proceeding with upsert.")
