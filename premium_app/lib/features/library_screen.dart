  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          const Icon(Icons.menu, color: PremiumTokens.saffronGlow, size: 28),
          Text(
            "Sant-Vaani",
          ...
          Row(
            children: [
              const Icon(Icons.notifications_none, color: PremiumTokens.saffronGlow, size: 24),
      ...
      child: Container(
        ...
        child: TextField(
          decoration: InputDecoration(
            ...
            icon: const Icon(Icons.search, color: PremiumTokens.saffronGlow),
          ),
        ...
        child: Row(
          children: [
            Container(
              ...
              child: const Center(
                child: Icon(Icons.spa, color: PremiumTokens.saffronGlow, size: 28),
              ),
            ),
            const SizedBox(width: 16),
            Expanded(
            ...
            Container(
              ...
              child: const Icon(Icons.play_arrow, color: PremiumTokens.saffronGlow, size: 20),
            ),
          ],
        ),
      ),
